 ...
 */
// ---- MinGW / MSYS2 compatibility fixes ----
#if defined(__MINGW32__) || defined(__MINGW64__)
  /* MinGW doesn't provide CreateFile2 and sometimes reports older _WIN32_WINNT.
     Disable mmap usage in httplib and provide fallback for CreateFile2. */
  #ifndef CPPHTTPLIB_NO_MMAP
    #define CPPHTTPLIB_NO_MMAP
  #endif
  /* Prevent the version-check error in some httplib copies */
  #ifdef _WIN32_WINNT
    #undef _WIN32_WINNT
  #endif
  /* Pretend to be Win10 for the header checks */
...
inline bool mmap::open(const char *path) {
  close();
#if defined(_WIN32) && !defined(CreateFile2)
  #include <windows.h> /* ensure CreateFileW etc are declared */
  /* Map CreateFile2(...) to CreateFileW(...) for MinGW (ignore extended params) */
  #define CreateFile2(path, access, share, disposition, params) \
    CreateFileW((path), (access), (share), NULL, (disposition), FILE_ATTRIBUTE_NORMAL, NULL)
#endif
